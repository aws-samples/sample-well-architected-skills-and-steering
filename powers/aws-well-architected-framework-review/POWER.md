...
keywords: ["well-architected", "wa review", "architecture review", "security review", "reliability", "cost optimization", "performance", "sustainability", "operational excellence", "pillar", "best practices", "aws architecture", "infrastructure review", "cloud review", "WAF", "aws-well-architected-framework-review"]
author: "AWS"
---
...
|----------|--------------|-------------------|
| Full or pillar-scoped WA review | `steering/aws-well-architected-framework-review.md` | User asks for a review, assessment, or architecture health check |
...
The power includes the AWS Well-Architected Framework reference corpus in two complementary layers, plus 27 lens extensions:
