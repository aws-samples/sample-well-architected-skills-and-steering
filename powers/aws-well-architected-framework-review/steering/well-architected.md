...
|-------------------|----------|----------|
| "security review/assessment/audit", "IAM review", "encryption check" | security-assessment | aws-well-architected-framework-review |
| "reliability/availability/failover", "single point of failure", "DR" | reliability-improvement-plan | aws-well-architected-framework-review |
| "cost/spend/budget/savings", "right-sizing", "waste" | cost-optimization-review | aws-well-architected-framework-review |
| "performance/latency/throughput", "scaling", "caching" | performance-efficiency | aws-well-architected-framework-review |
| "sustainability/carbon/green", "energy efficiency" | sustainability-optimization | aws-well-architected-framework-review |
| "operational/CI-CD/observability", "deployment strategy", "incidents" | operational-excellence | aws-well-architected-framework-review |
| "migrate/migration/7Rs", "on-prem to cloud", "lift and shift" | migration-readiness | aws-well-architected-framework-review |
| "ADR/decision record", "document our choice", "compare options" | architecture-decision-record | aws-well-architected-framework-review |
| "learn WA/teach me", "diagram", "visual roadmap" | wa-builder | aws-well-architected-framework-review |
| "full review/all pillars/comprehensive", "WA review" | aws-well-architected-framework-review | single-pillar skills |
| Ambiguous (mentions 2+ pillars equally) | aws-well-architected-framework-review | — |
...
4. **Cross-pillar → aws-well-architected-framework-review**: If the request spans 3+ pillars or says "comprehensive/full/all", use aws-well-architected-framework-review
...
- If the user asks about a specific WA Lens (SaaS, Serverless, etc.), use aws-well-architected-framework-review with the lens applied
...
```
    ...
    │          │     │          │     │          │
    │aws-well-architected-framework-review │     │ pillar   │     │aws-well-architected-framework-review │
...
- **Assess**: Identify gaps (aws-well-architected-framework-review, pillar skills)
...
| pillar_findings | Any pillar skill's output | aws-well-architected-framework-review (aggregation), follow-up skills |
| risk_level | Assessment skills (risk matrix) | Remediation prioritization |
| compliance_framework | User input | security-assessment, aws-well-architected-framework-review |
| architecture_diagram | aws-well-architected-framework-review Step 2, wa-builder | All skills (visual reference) |
