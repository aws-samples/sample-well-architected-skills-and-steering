...
def main():
    ...
    # Warn when aws-well-architected-framework-review is being measured with raw Converse — it needs Task
    # subagents which this framework can't execute. Point at the real harness.
    if "aws-well-architected-framework-review" in skills_to_run:
        print(
            "\n"
            "  " + "!" * 68 + "\n"
